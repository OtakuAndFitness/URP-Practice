    ...
    public class ProfilerServiceImpl : SRServiceBase<IProfilerService>, IProfilerService
    {
        ...
        protected override void Update()
        {
            ...
            for (var i = 0; i < _cameraListeners.Count; i++)
            {
                ...
                //    continue;
                if(!IsActiveAndEnabled(_cameraListeners[i]) || !IsActiveAndEnabled(_cameraListeners[i].Camera))
                    continue;
        ...
        bool IsActiveAndEnabled(Behaviour b)
        {
            return b && b.gameObject.activeInHierarchy && b.enabled;
        }
    }
}
