...
namespace SRDebugger.Editor
{
    public class SRDebuggerSettingsWindow : EditorWindow
    {
        ...
        private void DrawTabLayout()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            var rect = GUILayoutUtility.GetRect(320, 190);
            GUILayout.FlexibleSpace();
            EditorGUILayout.EndHorizontal();
...

            {
                ...
                Settings.Instance.ProfilerAlignment =
                    (PinAlignment) EditorGUILayout.EnumPopup(Settings.Instance.ProfilerAlignment);
...

            {
                ...
                Settings.Instance.OptionsAlignment =
                    (PinAlignment) EditorGUILayout.EnumPopup(Settings.Instance.OptionsAlignment);
