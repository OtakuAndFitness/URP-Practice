...
{
    [VolumeComponentEditor(typeof(ColorReplaceV2))]
    public class ColorReplaceV2Editor : VolumeComponentEditor
    {
        ...
        {
            var o = new PropertyFetcher<ColorReplaceV2>(serializedObject);
