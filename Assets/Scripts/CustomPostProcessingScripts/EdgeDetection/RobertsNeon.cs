...
namespace PostProcessingExtends.Effects
{
    ...
    public class RobertsNeon : CustomPostProcessingBase
    {
        ...
        private const string _shaderName = "Custom/PostProcessing/EdgeDetection/RobertsNeon";
        ...
        private int _paramsKeyword = Shader.PropertyToID("_RobertsNeonParams");
        private int _backgroundKeyword = Shader.PropertyToID("_RobertsNeonBackgroundColor");
        ...
        public override int OrderInInjectionPoint => 26;
