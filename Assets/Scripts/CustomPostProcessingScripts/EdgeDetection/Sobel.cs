...
namespace PostProcessingExtends.Effects
{
    ...
    public class Sobel : CustomPostProcessingBase
    {
        ...
        private const string _shaderName = "Custom/PostProcessing/EdgeDetection/Sobel";
        ...
        private int _paramsKeyword = Shader.PropertyToID("_SobelParams");
        private int _edgeColorKeyword = Shader.PropertyToID("_SobelEdgeColor");
        private int _backgroundKeyword = Shader.PropertyToID("_SobelBackgroundColor");
        ...
        public override int OrderInInjectionPoint => 29;
