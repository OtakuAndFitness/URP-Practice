...
namespace PostProcessingExtends.Effects
{
    ...
    public class ScharrNeon : CustomPostProcessingBase
    {
        ...
        private const string _shaderName = "Custom/PostProcessing/EdgeDetection/ScharrNeon";
        ...
        private int _paramsKeyword = Shader.PropertyToID("_ScharrNeonParams");
        private int _backgroundKeyword = Shader.PropertyToID("_ScharrNeonBackgroundColor");
        ...
        public override int OrderInInjectionPoint => 28;
