...
namespace PostProcessingExtends.Effects
{
    ...
    public class Roberts : CustomPostProcessingBase
    {
        ...
        private const string _shaderName = "Custom/PostProcessing/EdgeDetection/Roberts";
        ...
        private int _paramsKeyword = Shader.PropertyToID("_RobertsParams");
        private int _edgeColorKeyword = Shader.PropertyToID("_RobertsEdgeColor");
        private int _backgroundKeyword = Shader.PropertyToID("_RobertsBackgroundColor");
        ...
        public override int OrderInInjectionPoint => 25;
