...
namespace PostProcessingExtends.Effects
{
    ...
    public class Sector : CustomPostProcessingBase
    {
        ...
        private const string _shaderName = "Custom/PostProcessing/Pixelise/Sector";
        ...
        private int _paramsKeyword = Shader.PropertyToID("_SectorParams");
        private int _params2Keyword = Shader.PropertyToID("_SectorParams2");
        private int _backgroundKeyword = Shader.PropertyToID("_SectorBackground");
        ...
        public override int OrderInInjectionPoint => 48;
