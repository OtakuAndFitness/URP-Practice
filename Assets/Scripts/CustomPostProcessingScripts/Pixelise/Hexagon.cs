...
{
    [Serializable, VolumeComponentMenu("Custom-Post-Processing/Pixelise/Hexagon")]
    public class Hexagon : VolumeComponent, IPostProcessComponent
    {
        public ClampedFloatParameter pixelSize = new ClampedFloatParameter(0, 0, 1);
        // public ClampedFloatParameter gridWidth = new ClampedFloatParameter(1, 0.01f, 1);
        ...
        // private const string _shaderName = "Custom/PostProcessing/Pixelise/Hexagon";
        ...
        // private int _pixelSizeKeyword = Shader.PropertyToID("_HexagonPixelSize");
        // private int _paramsKeyword = Shader.PropertyToID("_HexagonParams");
        ...
        // public override int OrderInInjectionPoint => 43;
        //
        ...
        //     float size = pixelSize.value * 0.2f;
        ...
        //         }
        //     }
        //     cmd.SetGlobalVector(_paramsKeyword, new Vector4(size,ratio, pixelScaleX.value,pixelScaleY.value));
        //     
