...
namespace PostProcessingExtends.Effects
{
    ...
    public class Led : CustomPostProcessingBase
    {
        ...
        private const string _shaderName = "Custom/PostProcessing/Pixelise/Led";
        ...
        private int _paramsKeyword = Shader.PropertyToID("_LedParams");
        private int _backgroundKeyword = Shader.PropertyToID("_LedBackground");
        ...
        public override int OrderInInjectionPoint => 46;
        ...
        public override void Render(CommandBuffer cmd, ref RenderingData renderingData, in RTHandle source, in RTHandle destination)
        {
            ...
            cmd.SetGlobalVector(_paramsKeyword, new Vector3(size, ratio, ledRadius.value));
