...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class Circle : VolumeComponent, IPostProcessComponent
    {
        public ClampedFloatParameter pixelSize = new ClampedFloatParameter(0.8f, 0.01f, 1);
        public ClampedFloatParameter circleRadius = new ClampedFloatParameter(0, 0, 1);
        ...
        {
            return active && circleRadius.value != 0;
        }
