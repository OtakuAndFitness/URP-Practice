...
namespace PostProcessingExtends.Effects
{
    ...
    public class Contrast : CustomPostProcessingBase
    {
        public ClampedFloatParameter contrast = new ClampedFloatParameter(0, 0, 2);
        
        private const string _shaderName = "Custom/PostProcessing/ColorAdjustment/Contrast";
        ...
        private int _contrastKeyword = Shader.PropertyToID("_Contrast");
        
        public override bool IsActive() =>  _material != null && contrast.value > 0;
        

        public override CustomPostProcessingInjectionPoint InjectionPoint =>
            CustomPostProcessingInjectionPoint.AfterPostProcess;
        public override int OrderInInjectionPoint => 16;
        ...
        public override void Render(CommandBuffer cmd, ref RenderingData renderingData, in RTHandle source, in RTHandle destination)
        {
            ...
            cmd.SetGlobalFloat(_contrastKeyword, contrast.value + 1);
