...
namespace PostProcessingExtends.Effects
{
    ...
    public class Brightness : CustomPostProcessingBase
    {
        public ClampedFloatParameter brightness = new ClampedFloatParameter(0, 0, 10);
        
        private const string _shaderName = "Custom/PostProcessing/ColorAdjustment/Brightness";
        ...
        private int _brightnessKeyword = Shader.PropertyToID("_Brightness");
        
        public override bool IsActive() =>  _material != null && brightness.value > 0;
        

        public override CustomPostProcessingInjectionPoint InjectionPoint =>
            CustomPostProcessingInjectionPoint.AfterPostProcess;
        public override int OrderInInjectionPoint => 12;
        ...
        public override void Render(CommandBuffer cmd, ref RenderingData renderingData, in RTHandle source, in RTHandle destination)
        {
            ...
            cmd.SetGlobalFloat(_brightnessKeyword, brightness.value);
