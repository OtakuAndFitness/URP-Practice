...
namespace PostProcessingExtends.Effects
{
    ...
    public class Tint : CustomPostProcessingBase
    {
        ...
        private const string _shaderName = "Custom/PostProcessing/ColorAdjustment/Tint";
        ...
        private int _indensityKeyword = Shader.PropertyToID("_TintIndensity");
        private int _colorTintKeyword = Shader.PropertyToID("_ColorTint");
        ...
        public override int OrderInInjectionPoint => 23;
        ...
        public override void Render(CommandBuffer cmd, ref RenderingData renderingData, in RTHandle source, in RTHandle destination)
        {
            ...
            cmd.SetGlobalColor(_colorTintKeyword, colorTint.value);
