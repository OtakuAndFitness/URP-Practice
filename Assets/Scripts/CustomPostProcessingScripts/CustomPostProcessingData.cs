...
namespace PostProcessingExtends
{
    ...
    public class CustomPostProcessingData : ScriptableObject
    {
        ...
        private static void AssignShaders(CustomShaders customShaders)
        {
            ...
            customShaders.colorReplaceV2 = Shader.Find("Custom/PostProcessing/ColorAdjustment/ColorReplaceV2");
            ...
            customShaders.copyMaterial = Shader.Find("Hidden/PostProcess/PostProcessCopy");
